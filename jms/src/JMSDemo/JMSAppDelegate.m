...
//    Uncomment the following lines to register for Pre-iOS8 Notifications. Note that APNs functionality
//    is available in Kaazing Gateway 4.x releases. It is temporarily unavailable in Kaazing Gateway 5.0.
//    [[UIApplication sharedApplication] registerForRemoteNotificationTypes:(UIRemoteNotificationTypeAlert |
//                                                                           UIRemoteNotificationTypeSound)];

//    Uncomment the following lines to register for iOS8 Notifications. Note that APNs functionality
//    is available in Kaazing Gateway 4.x releases. It is temporarily unavailable in Kaazing Gateway 5.x.
